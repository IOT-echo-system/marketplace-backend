...
export interface ApiAddressBySellerAddressBySeller extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::address-by-seller.address-by-seller', 'oneToOne', 'admin::user'> &
      Attribute.Private
    updatedBy: Attribute.Relation<'api::address-by-seller.address-by-seller', 'oneToOne', 'admin::user'> &
      Attribute.Private
  }
}
...
export interface ApiDiscountCouponDiscountCoupon extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::discount-coupon.discount-coupon', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::discount-coupon.discount-coupon', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiMainMenuMainMenu extends Schema.SingleType {
  ...
  attributes: {
    categories: Attribute.Relation<'api::main-menu.main-menu', 'oneToMany', 'api::category.category'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::main-menu.main-menu', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::main-menu.main-menu', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categories: Attribute.Relation<'api::product.product', 'oneToMany', 'api::category.category'>
    tags: Attribute.Relation<'api::product.product', 'oneToMany', 'api::tag.tag'>
    ...
    description: Attribute.RichText &
      ...
      >
    additionalDetails: Attribute.RichText &
      Attribute.CustomField<
        'plugin::ckeditor.CKEditor',
        {
          output: 'HTML'
...
export interface ApiShippingShipping extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::shipping.shipping', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::shipping.shipping', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiSiteInfoSiteInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::site-info.site-info', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::site-info.site-info', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiStoreLocationStoreLocation extends Schema.SingleType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::store-location.store-location', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::store-location.store-location', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    link: Attribute.UID<'api::tag.tag', 'name'> & Attribute.Required
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
